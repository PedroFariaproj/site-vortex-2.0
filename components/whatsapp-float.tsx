 ...
 *
 * - Visível em todas as telas (presente no mock de referência).
 * - Abre uma conversa no WhatsApp com mensagem pré-preenchida.
 * - Anel pulsante para chamar atenção, sem ser intrusivo.
 * - Touch target de 56px (acima do mínimo de 44px exigido em mobile).
 */
const WHATSAPP_NUMBER = "5511994576716"
const WHATSAPP_MESSAGE = "Olá! Vim pelo site da Vortex e gostaria de solicitar um orçamento."
  ...
  return (
    <a
      ...
      className="
        ...
        shadow-[0_8px_30px_-6px_rgba(37,211,102,0.6)]
